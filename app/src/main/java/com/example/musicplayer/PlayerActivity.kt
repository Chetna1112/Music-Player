...
import com.harshRajpurohit.musicPlayer.*
...
class PlayerActivity : AppCompatActivity(), ServiceConnection, MediaPlayer.OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.playPause.setOnClickListener { if (isPlaying) pauseMusic() else playMusic() }
    ...
    private fun setLayout() {
        ...
        Glide.with(applicationContext)
            ...
            .apply(
                RequestOptions().placeholder(R.drawable.muisc_player_icon_splash_screen).centerCrop()
            )
            .into(binding.songImgPA)
        binding.songNamePA.text = musicListPA[songPosition].title
        ...
        val image = if (img != null) {
            ...
            BitmapFactory.decodeResource(
                resources,
                R.drawable.muisc_player_icon_splash_screen
            )
        }
